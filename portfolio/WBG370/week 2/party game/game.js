...
game.checkForEndGame = function()
{
	if(game.bop.total === atom.winningScore)
	{
		game.bop.draw;
	}
	else
...
game.bop = {
	...
	draw:function()
	{
		if(this.total < atom.winningScore)
		{
		...
		else
		{
			atom.context.fillStyle = '#000';
			atom.context.font = '130px monospace';
			atom.context.fillText('You Win! ' + this.total, 300, 200);
			game.stop();
		}
	},
