...
var CoinEntity = me.CollectableEntity.extend({
  init: function(x, y, settings) {
    this.parent(x, y, settings);
	if(me.gamestat.getItemValue("coinsLeft") <= 0)
	{
		me.gamestat.updateValue("coinsLeft", 7);
	}
  },
  onCollision : function (res, obj) {
    me.gamestat.updateValue("coins", 1);
	if(me.gamestat.getItemValue("coinsLeft") >=1)
	{
		me.gamestat.updateValue("coinsLeft", -1)
		if(me.gamestat.getItemValue("coinsLeft") <= 0)
		{
			me.gamestat.updateValue("coinsLeft", 7);
		}
    ...
    me.game.remove(this);
	document.getElementById('coinTotal').innerHTML = "Coin Total: " + me.gamestat.getItemValue("coins") + " Coins Left: " + me.gamestat.getItemValue("coinsLeft");
...
var EnemyEntity2 = me.ObjectEntity.extend ({
	...
	onCollision: function(res, obj){
		if(me.gamestat.getItemValue("coins") >=1)
		{
			me.gamestat.updateValue("coins", -1);
			if(me.gamestat.getItemValue("coinsLeft") <= 6)
			{
				obj.gameOver();
			}
		}
